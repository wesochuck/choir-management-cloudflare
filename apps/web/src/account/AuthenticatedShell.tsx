...
const organizationGroups: readonly NavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/donations", label: "Donations & patrons", module: "programs" },
...
function pageTitle(pathname: string): string {
  const titles: readonly [string, string][] = [
    ...
    ["/admin/donations", "Donations & patrons"],
...
function renderOrganizationPage(
  ...
  const pages: Record<string, ReactNode> = {
    ...
    "/admin/tickets/scan": <TicketingManager enabled={focusedEnabled} />,
