    ...
    >
      ...
      <form className="form-stack" onSubmit={(event) => void handleSubmit(event)}>
        <div className="form-grid">
          ...
          <div className="field">
            <label htmlFor="manual-donation-date">Date received</label>
            <input
              disabled={busy}
              id="manual-donation-date"
              onChange={(event) => {
        ...
        <div className="field">
          <label className="field__label-row" htmlFor="manual-donation-donor-email">
          ...
          <input
            ...
            value={donorEmail}
          />
          <p className="field-help" id="manual-donation-donor-email-help">
        ...
        <div className="form-grid">
          ...
          <div className="field">
            <label className="field__label-row" htmlFor="manual-donation-payment-reference">
        ...
        {tributeType === "honor" || tributeType === "memory" ? (
          <div className="form-grid">
            ...
            <div className="field">
              <label className="field__label-row" htmlFor="manual-donation-tribute-notify-email">
