...
const provision = async (id: string, slug: string, profileId: string, eventId: string) => {
...
beforeEach(async () => {
  ...
  await seedAuthUser(database, "public-rsvp", "public.rsvp@example.test", "Public RSVP");
