...
const expectedApiRoutes = [
  ...
  "GET /api/platform/job-dead-letters",
  "POST /api/platform/job-dead-letters/:deadLetterId/dismiss",
  "POST /api/platform/job-dead-letters/:deadLetterId/retry",
  "POST /api/test-smtp",
  "POST /api/test-sms",
  "POST /api/organization/player-tokens",
  "POST /api/public/tickets/checkout",
  "GET /api/public/tickets/discount-availability",
  "POST /api/public/tickets/quote",
  "GET /api/organization/tickets/discount-codes",
  ...
  "POST /api/organization/donations/manual",
  "POST /api/organization/donations/thank-you",
