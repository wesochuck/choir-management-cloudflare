...
| `apps/worker/src/organization/schema/migrations.ts`                      | Exact ordered forward-only Organization migration registry, including folder-return, poll-expiration backfill, and communication dedupe fields                  |
...
| `apps/worker/src/organization/paymentCleanupStore.ts`                    | Seven-day stale pending-payment expiration backstop                                                                                                             |
