...
| `apps/worker/src/organization/schema/migrations.ts`                      | Exact ordered forward-only Organization migration registry, including folder-return and communication dedupe fields                                             |
...
| `apps/web/e2e/responsive.audit.spec.ts`                                  | Responsive shell audit plus member schedule Yes/No controls, RSVP feedback, and decline-dialog browser regression coverage                                      |
