...
| `apps/web/e2e/responsive.audit.spec.ts`                                  | Responsive shell audit plus member RSVP feedback and decline-dialog browser regression coverage                                                         |
...
| `apps/worker/test/selfServiceRsvp.integration.test.ts`                   | Linked-Profile RSVP authorization, inheritance, rehearsal-note enforcement, notice queueing, and cross-tenant denial proof                              |
