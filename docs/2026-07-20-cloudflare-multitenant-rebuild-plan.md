...
| `docs/adr/0031-preserve-music-folder-history.md`                         | Profile-retention rule for historical music-folder accountability                                                                                                                                                         |
| `docs/2026-08-08-music-folder-report-implementation-plan.md`             | Accepted Music Folder Report product contract, implementation sequence, risks, and gates                                                                                                                                  |
...
| `scripts/check-ci.mjs`                                                   | Complete local CI mirror: security, formatting, lint, types, contracts, parity, unit/integration tests, and immutable release build                                                                                       |
| `scripts/deploy-staging-local.mjs`                                       | Sole guarded permanent-staging promotion path, including exact-artifact qualification and automatic traffic rollback                                                                                                      |
...
| `apps/web/src/auth/api/platform.ts`                                      | Typed Platform Administrator API client, including queue dead-letter review and actions                                                                                                                                   |
...
| `apps/web/src/auth/EmailChangeConfirmationView.tsx`                      | Public one-time confirmation screen for member sign-in email changes                                                                                                                                                      |
...
| `apps/web/src/account/components/AuthenticatedShell/shell.tsx`           | Authenticated workspace shell, grouped navigation, route guards, and responsive drawer                                                                                                                                    |
| `apps/web/src/account/PlatformAccess.tsx`                                | Platform Administrator MFA enrollment and verification UI                                                                                                                                                                 |
| `apps/web/src/account/PlatformEmailSuppressions.tsx`                     | MFA-gated Platform Administrator view of the application-wide email suppression ledger                                                                                                                                    |
| `apps/web/src/account/PlatformOperations.tsx`                            | Platform Administrator Organization provisioning, scoped elevation, and queue dead-letter operations UI                                                                                                                   |
...
| `apps/web/src/account/components/RosterPage/controller.tsx`              | Focused responsive Organization Profile roster, CSV actions, and Profile dialogs                                                                                                                                          |
| `apps/web/src/account/components/EventsPage/page.tsx`                    | Focused Organization event list, filters, editor, clone, and archive flows                                                                                                                                                |
...
| `apps/web/src/account/RosterAutomationSettings.tsx`                      | Visible Profile Status Automation, On Break Timeout, RSVP Expiry, scheduled RSVP follow-up, attendance warning settings, previews, and rule explanation                                                                   |
| `apps/web/src/account/PollsPage.tsx`                                     | Focused Organization poll list, required expiration editor, and three-day create default                                                                                                                                  |
| `apps/web/src/account/ReportsView.tsx`                                   | Existing reports tab host and Music Folder Report composition                                                                                                                                                             |
| `apps/web/src/account/components/MusicFolderReport/controller.tsx`       | Music-folder report requests, mutations, and staged-draft lifecycle                                                                                                                                                       |
| `apps/web/src/account/components/MusicFolderReport/view.tsx`             | Accessible Performance selector, summary, detail editor, and report states                                                                                                                                                |
| `apps/web/src/account/components/MusicFolderReport/model.ts`             | Pure browser filtering, sorting, draft, and partial-result helpers                                                                                                                                                        |
| `apps/web/src/account/components/MusicFolderReport/model.test.ts`        | Browser-model unit proof for report interactions                                                                                                                                                                          |
| `apps/web/src/auth/api/musicFolderReports.ts`                            | Same-origin typed Music Folder Report browser client                                                                                                                                                                      |
| `apps/web/src/styles/components/reports.css`                             | Tokenized responsive styling for report tables, cards, detail editors, and report states                                                                                                                                  |
| `apps/web/src/account/MySchedule.tsx`                                    | Linked-Profile member schedule, Yes/No self-service RSVP UI, and parent-declined rehearsal visibility                                                                                                                     |
| `apps/web/src/account/DashboardView.tsx`                                 | Member dashboard RSVP actions, visible mutation feedback, and rehearsal-decline dialog                                                                                                                                    |
| `apps/web/src/account/components/RosterPage/view.tsx`                    | Organization Profile preference controls, including RSVP decline notices                                                                                                                                                  |
...
| `apps/web/src/account/components/SeatingManager/controller.tsx`          | Focused administrator seating canvas, chart tools, drag/drop fallback, mobile editor, autosave, print/list, and Profile lookup                                                                                            |
...
| `apps/web/src/account/components/MusicCatalog/controller.tsx`            | Manager catalog, CSV, movement, private learning-track, and deletion workflows                                                                                                                                            |
...
| `apps/web/src/account/components/SetListManager/controller.tsx`          | Manager event set-list ordering, approval, music linking, and performer-credit UI                                                                                                                                         |
| `apps/web/src/account/components/AuditionManager/page.tsx`               | Administrator audition inquiry, slot settings, scheduling, conversion, notification, and token UI                                                                                                                         |
...
| `apps/worker/src/routes/platformAdministration.ts`                       | MFA-gated Platform Administrator operations, including audited dead-letter retry and dismissal                                                                                                                            |
| `apps/worker/src/routes/platformEmailSuppressions.ts`                    | MFA-gated, product-base API for searching and paginating global email suppressions                                                                                                                                        |
| `apps/worker/src/routes/memberEmailChange.ts`                            | Member email-change request and Organization-host-bound confirmation routes                                                                                                                                               |
...
| `apps/worker/src/organization/organizationStore/profiles.ts`             | Organization Profile mutation repository, including music-folder history deletion protection                                                                                                                              |
| `apps/worker/src/organization/musicFolderReportStore.ts`                 | Tenant-local music-folder report queries, edits, uniqueness, audit, and CSV projection                                                                                                                                    |
| `apps/worker/src/organization/organizationMusicFolderReports.ts`         | Authenticated Music Folder Report repository adapter                                                                                                                                                                      |
| `apps/worker/src/routes/organizationMusicFolderReports.ts`               | Manager-authorized Music Folder Report and export routes                                                                                                                                                                  |
| `apps/worker/src/routes/organizationProfileRecords.ts`                   | Profile record routes, including compatibility Folder Number and immediate return-state actions                                                                                                                           |
...
| `apps/worker/src/organization/musicStore.ts`                             | Organization-scoped music catalog repository, referential validation, and genre-label registry                                                                                                                            |
| `apps/worker/src/organization/organizationMusic.ts`                      | Authenticated Music Library repository adapter, including publisher search settings and genre-label mutations                                                                                                             |
...
| `apps/worker/src/organization/organizationStore/providerFeedback.ts`     | Organization-side provider feedback updates and local notification outcome history                                                                                                                                        |
| `apps/worker/src/organization/schema.ts`                                 | Operational schema and schema-version registry                                                                                                                                                                            |
| `apps/worker/src/organization/schema/migrations.ts`                      | Exact ordered forward-only Organization migration registry, including folder-return, poll-expiration backfill, communication dedupe fields, ticket discount codes, redemption reservations, and immutable order snapshots |
| `apps/worker/src/organization/schedulingStore.ts`                        | Organization-scoped event-reminder, pending RSVP follow-up, attendance finalization, recipient, and report data reader                                                                                                    |
| `apps/worker/src/organization/migrations.ts`                             | Ordered, forward-compatible Organization migrations                                                                                                                                                                       |
| `apps/worker/src/organization/scheduler.ts`                              | Per-Organization alarm and stable queue outbox orchestration, including RSVP follow-up and post-event jobs                                                                                                                |
...
| `apps/worker/src/auth/emailChange.ts`                                    | D1-backed verified member email changes, notification outbox, retry, and audit orchestration                                                                                                                              |
...
| `apps/worker/src/control/migrations/0009_stripe_connected_accounts.sql`  | Authoritative Stripe connected-account-to-Organization routing map                                                                                                                                                        |
| `apps/worker/src/control/migrations/0010_email_feedback.sql`             | Email route, provider-event inbox, and global suppression control-plane schema                                                                                                                                            |
| `apps/worker/src/control/migrations/0011_job_dead_letter_actions.sql`    | Audited retry and dismissal state for queue dead-letter operations                                                                                                                                                        |
| `apps/worker/src/control/migrations/0014_email_change.sql`               | Forward-only member email-change requests, notification outbox, normalized lookup, and audit indexes                                                                                                                      |
...
| `apps/worker/src/jobs/consumer.ts`                                       | Queue dispatch, retries, dead-letter behavior, and template-backed scheduled event communications                                                                                                                         |
...
| `apps/worker/src/calendar/organizationCalendar.ts`                       | Authenticated venue, event, RSVP history, dashboard-summary, and typed RSVP-detail repository adapter                                                                                                                     |
...
| `apps/worker/src/organization/communicationStore.ts`                     | Organization message, recipient, template, audit, delivery-ledger, and deduplicated-message persistence                                                                                                                   |
| `apps/worker/src/organization/organizationCommunications.ts`             | Host-authorized Organization communications repository adapter and automated system-message queue                                                                                                                         |
| `apps/worker/src/organization/rsvpDeclineNotifications.ts`               | Organization-scoped RSVP decline recipient selection and retryable administrator notice composition                                                                                                                       |
| `apps/worker/src/communications/provider.ts`                             | Cloudflare Email Sending and fake/disabled/Brevo-sandbox SMS delivery adapter                                                                                                                                             |
| `apps/worker/src/communications/emailPresentation.ts`                    | Shared table-based, inline-styled HTML presentation for platform and Organization transactional email                                                                                                                     |
...
| `apps/worker/src/organization/ticketingStore.ts`                         | Tenant-local ticket settings, inventory reservations, Discount Code CRUD/reporting, atomic quote/redemption lifecycle, immutable order snapshots, and audit persistence                                                   |
| `apps/worker/src/organization/organizationTicketing.ts`                  | Host-authorized public/manager ticket repository, authoritative discounted checkout orchestration, Stripe handoff, and complimentary-order behavior                                                                       |
| `apps/worker/src/organization/organizationPaymentSettings.ts`            | Organization payment activation/readiness adapter                                                                                                                                                                         |
| `apps/worker/src/organization/paymentSettingsStore.ts`                   | Tenant-local payment activation settings and audit persistence                                                                                                                                                            |
| `apps/worker/src/organization/paymentDisputeStore.ts`                    | Tenant-local Stripe dispute alert and audit persistence                                                                                                                                                                   |
| `apps/worker/src/organization/paymentCleanupStore.ts`                    | Seven-day stale pending-payment expiration backstop, including release of pending Discount Code reservations                                                                                                              |
| `apps/worker/src/organization/paymentRefundStore.ts`                     | Tenant-local refund target and refund-request audit persistence                                                                                                                                                           |
| `apps/worker/src/organization/paymentNotificationStore.ts`               | Tenant-local payment confirmation queue and delivery ledger                                                                                                                                                               |
| `apps/worker/src/organization/paymentMessageTemplates.ts`                | Editable donation and dues confirmation templates with payment-specific rendering                                                                                                                                         |
| `apps/worker/src/payments/ticketCheckout.ts`                             | Fail-closed disabled/fake boundary and authoritative discounted line-item builder ahead of Stripe Connect direct-charge qualification                                                                                     |
| `apps/worker/src/payments/ticketCheckout.test.ts`                        | Checkout effect-mode, production-refusal, discounted line-item, fee, and complimentary-order unit proof                                                                                                                   |
| `apps/worker/src/payments/stripeConnect.test.ts`                         | Connected-account Checkout/Refund request and idempotency contract proof                                                                                                                                                  |
...
| `apps/worker/src/payments/stripeWebhookHandler.ts`                       | Connected-account-first Stripe event dispatch to tenant-local payment state transitions and dispute alerts                                                                                                                |
| `apps/worker/src/payments/stripeRouting.ts`                              | D1 connected-account routing and cross-Organization conflict protection                                                                                                                                                   |
| `apps/worker/src/payments/refundRequest.ts`                              | Connected-account refund request orchestration with stable idempotency                                                                                                                                                    |
| `apps/worker/test/stripeWebhook.test.ts`                                 | Stripe signature, stale/replay, multi-signature, and event-schema unit proof                                                                                                                                              |
| `apps/worker/test/ticketing.integration.test.ts`                         | Public/admin ticketing authorization, Discount Code CRUD/reporting, authoritative quotes, per-unit/bundle discounts, complimentary orders, limits, replay, capacity, tenant isolation, and payment-transition proof       |
...
| `packages/contracts/src/export-names.snapshot.json`                      | Checked public contract export-name snapshot                                                                                                                                                                              |
| `packages/contracts/src/musicFolderReports.ts`                           | Shared bounded Music Folder Report requests, responses, row results, and errors                                                                                                                                           |
| `packages/contracts/src/polls.test.ts`                                   | Required poll-expiration request-contract regression proof                                                                                                                                                                |
| `packages/domain/package.json`                                           | Pure domain rules and calculations                                                                                                                                                                                        |
| `packages/domain/src/index.ts`                                           | Public domain exports                                                                                                                                                                                                     |
| `packages/domain/src/polls.ts`                                           | Shared three-day poll-expiration calculation                                                                                                                                                                              |
| `packages/domain/src/polls.test.ts`                                      | Poll-expiration default regression proof                                                                                                                                                                                  |
| `packages/domain/src/musicFolderReport.ts`                               | Pure folder status, normalization, summary, ordering, and CSV rules                                                                                                                                                       |
| `packages/domain/src/musicFolderReport.test.ts`                          | Music-folder domain, collision, summary, ordering, and CSV regression proof                                                                                                                                               |
...
| `packages/domain/src/ticketing.test.ts`                                  | Ticket price/capacity/state-transition plus Discount Code normalization, validation, floor-at-zero, per-unit discount, fee, and quote unit proof                                                                          |
...
| `packages/testkit/src/workerd.ts`                                        | Shared Workerd integration-test harness (requests, provisioning, OTP sign-in)                                                                                                                                             |
...
| `docs/runbooks/email-feedback.md`                                        | Cloudflare Email Sending feedback, suppression, subscription, and staging qualification runbook                                                                                                                           |
| `docs/runbooks/queue-dead-letters.md`                                    | Operator workflow for reviewing, retrying, and dismissing queue dead letters                                                                                                                                              |
| `docs/runbooks/production-deployment.md`                                 | Operator runbook for production resource provisioning, secret configuration, and promotion                                                                                                                                |
...
| `scripts/parity-evidence-plan.mjs`                                       | Staging probe classification for implemented API routes, including elevated operator actions                                                                                                                              |
...
| `scripts/release-artifact.mjs`                                           | Creates and verifies the immutable Worker/web release manifest promoted through isolated Cloudflare environments                                                                                                          |
| `scripts/release-artifact.test.mjs`                                      | Unit proof that release manifests detect changed, missing, and unexpected deployable files                                                                                                                                |
...
| `apps/web/e2e/reports.spec.ts`                                           | Desktop/mobile Music Folder Report interaction, accessibility, and regression evidence                                                                                                                                    |
| `apps/web/e2e/responsive.audit.spec.ts`                                  | Responsive shell audit plus poll expiration, member schedule Yes/No controls, RSVP feedback, and decline-dialog browser regression coverage                                                                               |
| `apps/web/src/account/components/CommunicationCenter/controller.tsx`     | Responsive manager compose, drafts, templates, history, and delivery visibility                                                                                                                                           |
...
| `apps/web/src/account/TicketingManager.tsx`                              | Manager event ticket settings, capacity, orders/refunds, Discount Code CRUD/deactivation, eligibility, limits, and redemption/revenue reporting                                                                           |
| `apps/web/src/public/PublicTickets.tsx`                                  | Published ticket catalog, conditional Discount Code entry, authoritative quote/validation, checkout, complimentary-order, and discounted receipt views                                                                    |
...
| `apps/worker/test/selfServiceRsvp.integration.test.ts`                   | Linked-Profile RSVP authorization, inheritance, parent-declined rehearsal filtering, rehearsal-note enforcement, notice queueing, and cross-tenant denial proof                                                           |
| `apps/worker/test/attendance.integration.test.ts`                        | Attendance transaction, RSVP promotion, audit, and tenant-isolation proof                                                                                                                                                 |
| `apps/worker/test/musicFolderReport.integration.test.ts`                 | Music-folder report migration, behavior, authorization, audit, export, and tenant-isolation proof                                                                                                                         |
...
| `apps/web/src/account/components/AuditionManager/page.tsx`               | Administrator audition list, status editing, and token generation UI                                                                                                                                                      |
...
| `apps/worker/test/publicRsvp.integration.test.ts`                        | Public RSVP authorization, rehearsal-note enforcement, token replay, and isolation integration proof                                                                                                                      |
| `apps/worker/test/publicPoll.integration.test.ts`                        | Public poll authorization, legacy expiration backfill, token replay, and isolation integration proof                                                                                                                      |
...
| `apps/web/e2e/ticketing.spec.ts`                                         | Public ticket purchase, conditional Discount Code quote/apply, complimentary receipt, and manager CRUD/reporting browser coverage                                                                                         |
| `docs/parity/screenshots/README.md`                                      | Baseline screenshot provenance and regeneration contract                                                                                                                                                                  |

### Refactor decomposition additions

The decomposition milestone owns these review-sized implementation units. Existing public entry
paths remain barrels where callers already import them.

| Path                                                                                                                                                                                        | Responsibility                                                                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| `packages/contracts/src/{primitives,platform,setup,auth,organization,profiles,events,music,resources,communications,polls,auditions,seating,ticketing,donations,seasons,exports,player}.ts` | Domain-ordered contract schemas and DTOs                                                              |
| `packages/contracts/src/export-names.snapshot.json`                                                                                                                                         | Pre-split contract export surface snapshot                                                            |
| `apps/web/src/auth/api/{client,organization,music,events,communications,ticketing,donations,seasons,profiles,platform,setup,public,singer,account,files,resources,auditions,player}.ts`     | Typed browser API modules behind `auth/api.ts`                                                        |
| `apps/worker/src/jobs/deliveries/{shared,communication,scheduledEvents,tickets,auditions,payments,export,cleanup}.ts`                                                                       | Delivery-specific queue handlers behind `jobs/consumer.ts`                                            |
| `apps/worker/src/routes/*.ts` and `apps/worker/src/routes/helpers/*.ts`                                                                                                                     | Explicitly ordered Hono route registrations and shared helpers                                        |
| `apps/worker/src/organization/schema/{index,templates,migrations}.ts`                                                                                                                       | Organization seed templates, migration registry, and schema barrel                                    |
| `apps/worker/src/organization/organizationStore/{storeShared,profiles,files,audit,provision,post,read}.ts`                                                                                  | Organization Durable Object handler domains and dispatchers                                           |
| `apps/web/src/account/components/**/*.tsx`                                                                                                                                                  | Semantically named UI components, subcomponents, and page implementations imported directly by routes |
| `apps/web/src/account/components/AuthenticatedShell/{hooks,types,utils}.ts`                                                                                                                 | Authenticated-shell route state, navigation data, theme helpers, and shared types                     |
| `apps/web/src/account/components/AuthenticatedShell/lazyComponents.ts`                                                                                                                      | Lazy route-component bindings kept separate from Fast Refresh component modules                       |
| `apps/web/src/account/components/AuditionManager/{types,utils}.ts`                                                                                                                          | Audition page contracts and pure display/request helpers                                              |
| `apps/web/src/account/components/CommunicationCenter/{hooks,types,utils}.ts`                                                                                                                | Communication controller hook, contracts, and pure helpers                                            |
| `apps/web/src/account/components/EventsPage/{types,utils}.ts`                                                                                                                               | Event page contracts and pure request/display helpers                                                 |
| `apps/web/src/account/components/MusicCatalog/{hooks,tableUtils,utils}.ts`                                                                                                                  | Music catalog controller hook, table helpers, and pure utilities                                      |
