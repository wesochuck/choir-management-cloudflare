...
| `apps/web/src/account/learningTrackFilename.ts`                          | Pure readable, bounded learning-track upload filename construction                                                                                 |
| `apps/web/src/account/MusicCatalog.test.ts`                              | Unit proof for readable, bounded learning-track upload filenames                                                                                   |
